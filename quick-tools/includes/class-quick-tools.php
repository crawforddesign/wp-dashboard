...
class Quick_Tools {
    ...
    private function define_dashboard_hooks() {
        ...
        // Meta box hooks for permissions
        $this->loader->add_action('add_meta_boxes', $documentation, 'add_permissions_meta_box');
        $this->loader->add_action('save_post', $documentation, 'save_permissions_meta_box');
